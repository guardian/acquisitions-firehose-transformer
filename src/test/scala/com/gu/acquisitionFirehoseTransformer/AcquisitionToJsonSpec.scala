...
class AcquisitionToJsonSpec extends FlatSpec with Matchers {
  it should "serialise an event to json" in {
    ...
    jsonString should be("""{"payment_frequency":"Monthly","country_code":"US","amount":20.0,"currency":"GBP","timestamp":"2018-12-13 14:15:04","campaignCode":"FAKE_ACQUISITION_EVENT"}""")
  }
}
